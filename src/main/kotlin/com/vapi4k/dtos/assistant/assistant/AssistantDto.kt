...
package com.vapi4k.dtos.assistant.assistant
...
import com.vapi4k.dtos.assistant.transcriber.CommonTranscriberDto
import com.vapi4k.dtos.assistant.voice.CommonVoiceDto
...
data class AssistantDto(
  ...
  val transportConfigurations: MutableList<com.vapi4k.dtos.assistant.TransportConfigurationDto> = mutableListOf(),
  ...
  override var clientMessages: MutableSet<AssistantClientMessageType> = com.vapi4k.dtos.assistant.assistant.DEFAULT_CLIENT_MESSAGES.toMutableSet(),
  override var serverMessages: MutableSet<AssistantServerMessageType> = com.vapi4k.dtos.assistant.assistant.DEFAULT_SERVER_MESSAGES.toMutableSet(),
  ...
  val voicemailDetectionDto: com.vapi4k.dtos.assistant.VoicemailDetectionDto = com.vapi4k.dtos.assistant.VoicemailDetectionDto(),

  @SerialName("analysisPlan")
  val analysisPlanDto: com.vapi4k.dtos.assistant.AnalysisPlanDto = com.vapi4k.dtos.assistant.AnalysisPlanDto(),

  @SerialName("artifactPlan")
  val artifactPlanDto: com.vapi4k.dtos.assistant.ArtifactPlanDto = com.vapi4k.dtos.assistant.ArtifactPlanDto(),

  @SerialName("messagePlan")
  val messagePlanDto: com.vapi4k.dtos.assistant.MessagePlanDto = com.vapi4k.dtos.assistant.MessagePlanDto(),
) : AssistantProperties, com.vapi4k.dtos.assistant.assistant.AssistantBridge {
  @Transient
  var updated = false
